...
By default, the `subOrigData` function transforms all data to a common reference scale (defined by the standard materials and assigned, calibrated values for those; by default VSMOW-SLAP) using data from co-analysis of different laboratory standards [Magozzi et al., 2021](https://doi.org/10.1111/2041-210X.13556). The calibrations used are documented in the function's return object.
...
```{r Dp_Honly, fig.width=5, fig.asp=0.8, out.width='45%'}
